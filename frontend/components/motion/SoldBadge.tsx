    ...
    return (
        <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/40 backdrop-blur-[2px] rounded-lg">
            <motion.div
                ...
                className="bg-white border-4 border-black text-black px-6 py-3 rounded-xl shadow-2xl transform"
            >
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs font-bold tracking-wider text-gray-500 uppercase mt-1">
                        via Undercut
                    </span>
                </div>
            </motion.div>
